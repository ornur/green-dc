...
export default function CalculateBanner() {
  return (
    <div className=" relative mb-24 aspect-[12/5] md:aspect-[16/3] lg:aspect-[21/3]">
      ...
      />
      <div className="absolute inset-0 flex flex-col items-center px-5 md:px-20 justify-center bg-gradient-to-r from-base-black from-4% via-base-black/80 to-transparent to-80%">
        <h1 className="text-md md:text-2xl lg:text-4xl font-bold text-white">
