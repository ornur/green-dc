...
export default function CalculateForm() {
  return (
    <>
      ...
      <div className="container mb-24 flex gap-5 px-20">
        <Form
          action={onSubmitHanlder}
          className="w-1/2 space-y-2 rounded-lg p-5 shadow-xl"
        >
          ...
          <Button
            ...
            onClick={() => toast.error("Sorry, this feature is not implemented yet")}
          >
            Calculate
          </Button>
        </Form>
        <div className="flex w-1/2 flex-col justify-center rounded-lg p-5 shadow-xl">
